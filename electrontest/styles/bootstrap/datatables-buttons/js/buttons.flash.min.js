...
z.Api.register("buttons.resize()",function(){f.each(l.clients,function(a,b){b.domElement!==y&&b.domElement.parentNode&&b.positionElement()})});z.ext.buttons.copyFlash=f.extend({},H,{className:"buttons-copy buttons-flash",text:function(a){return a.i18n("buttons.copy","Копировать")},action:function(a,b,c,d){d._fromFlash&&(this.processing(!0),a=d._flash,c=M(b,d),d=d.customize?d.customize(c.str,d):c.str,a.setAction("copy"),G(a,d),this.processing(!1),b.buttons.info(b.i18n("buttons.copyTitle","Скопировано в буфер"),
